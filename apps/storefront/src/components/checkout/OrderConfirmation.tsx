  ...
  if (!order) {
    return (
      ...
      >
        ...
        <Text>We couldn't find the order information. Please check the URL and try again.</Text>
      </Container>
    )
  }
      ...
      >
        ...
        >
          ...
          >
            ...
            <Divider my="3" />
            <Text>
              Shipping Method: {order.ShippingCost > 0 ? 'Standard Shipping' : 'Free Shipping'}
            </Text>
            <Text>Payment Method: {order.xp?.PaymentMethod || 'Not specified'}</Text>
          </VStack>
        </Container>
      </GridItem>
      <GridItem
