import { Container, HStack, Text, VStack, useDisclosure } from '@chakra-ui/react'
...
const Layout: FC = () => {
  ...
  const { allowAnonymous, isAuthenticated, isLoggedIn } = useOrderCloudContext()
    ...
    <>
      ...
      >
        <Container
          ...
          maxW={pathname === '/' || pathname === '/cart' ? 'full' : 'container.4xl'}
          mx="auto"
