...
import ListView from '../resource-list/ListView'
import ResourceSelector from '../resource-assignment/ResourceSelector'
...
import ResourceAssignmentCreateEditModal from '../resource-assignment/modals/ResourceAssignmentCreateEditModal'
